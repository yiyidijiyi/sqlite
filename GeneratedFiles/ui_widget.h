...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        textEdit_message->setGeometry(QRect(820, 10, 400, 300));
        ...
        pushButton_clearMessage->setGeometry(QRect(820, 320, 75, 23));
        ...
        pushButton_connectDB->setGeometry(QRect(20, 100, 75, 24));
        ...
        pushButton_disconnectDB->setGeometry(QRect(110, 100, 80, 24));
        pushButton_createDB = new QPushButton(groupBox);
        pushButton_createDB->setObjectName(QStringLiteral("pushButton_createDB"));
        pushButton_createDB->setGeometry(QRect(205, 100, 75, 24));
        groupBox_2 = new QGroupBox(Widget);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        groupBox_2->setGeometry(QRect(10, 280, 300, 120));
